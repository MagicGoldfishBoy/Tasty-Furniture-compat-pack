...
public class compatMediumFoodContainerEntity extends RandomizableContainerBlockEntity {

    public compatMediumFoodContainerEntity(BlockPos pPos, BlockState pBlockState) {
        super(foodblockcompatregistry.MEDIUM_CABINET_ENTITY.get(), pPos, pBlockState);
    }
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            compatMediumFoodContainerEntity.this.playSound(p_155064_, SoundEvents.CHEST_OPEN);
            compatMediumFoodContainerEntity.this.updateBlockState(p_155064_, true);
        }

        @Override
        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            compatMediumFoodContainerEntity.this.playSound(p_155074_, SoundEvents.CHEST_CLOSE);
            compatMediumFoodContainerEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        protected boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == compatMediumFoodContainerEntity.this;
            } else {
                return false;
            }
        }
    ...
    void updateBlockState(BlockState pState, boolean pOpen) {
        this.level.setBlock(this.getBlockPos(), pState.setValue(compatMediumFoodCabinet.OPEN, Boolean.valueOf(pOpen)), 3);
    }

    void playSound(BlockState pState, SoundEvent pSound) {
        Vec3i vec3i = pState.getValue(compatMediumFoodCabinet.HORIZONTALFACING).getNormal();

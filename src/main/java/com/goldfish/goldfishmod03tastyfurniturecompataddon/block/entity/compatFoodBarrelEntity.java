...
public class compatFoodBarrelEntity extends RandomizableContainerBlockEntity {

    public compatFoodBarrelEntity(BlockPos pPos, BlockState pBlockState) {
        super(foodblockcompatregistry.FOOD_BARREL_ENTITY.get(), pPos, pBlockState);
    }
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            compatFoodBarrelEntity.this.playSound(p_155064_, SoundEvents.BARREL_OPEN);
            compatFoodBarrelEntity.this.updateBlockState(p_155064_, true);
        }

        @Override
        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            compatFoodBarrelEntity.this.playSound(p_155074_, SoundEvents.BARREL_CLOSE);
            compatFoodBarrelEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        protected boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == compatFoodBarrelEntity.this;
            } else {
                return false;
            }
        }

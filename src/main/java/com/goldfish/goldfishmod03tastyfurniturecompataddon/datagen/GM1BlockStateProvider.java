...
public class GM1BlockStateProvider extends BlockStateProvider 
{
    ...
    //textures
     ...
     ResourceLocation banana_block_texture = modLoc("block/banana_block");
    ...
    public void buildBlockModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
      //.........plain
          net.minecraft.world.level.block.Block banana_block = foodblockcompatregistry.BANANA_BLOCK.get();
          simpleBlock(banana_block);
      //.........bricks
          net.minecraft.world.level.block.Block banana_bricks_block = foodblockcompatregistry.BANANA_BRICKS_BLOCK.get();
          simpleBlock(banana_bricks_block);
      //.........chiseled
          net.minecraft.world.level.block.Block banana_chiseled_block = foodblockcompatregistry.BANANA_CHISELED_BLOCK.get();
          simpleBlock(banana_chiseled_block);
      //.........tiles
          net.minecraft.world.level.block.Block banana_tiles_block = foodblockcompatregistry.BANANA_TILES_BLOCK.get();
          simpleBlock(banana_tiles_block);
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
      //.........plain
          net.minecraft.world.level.block.Block starfruit_block = foodblockcompatregistry.STARFRUIT_BLOCK.get();
          simpleBlock(starfruit_block);
      //.........bricks
          net.minecraft.world.level.block.Block starfruit_bricks_block = foodblockcompatregistry.STARFRUIT_BRICKS_BLOCK.get();
          simpleBlock(starfruit_bricks_block);
      //.........chiseled
          net.minecraft.world.level.block.Block starfruit_chiseled_block = foodblockcompatregistry.STARFRUIT_CHISELED_BLOCK.get();
          simpleBlock(starfruit_chiseled_block);
      //.........tiles
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
      //.........plain
          ...
          simpleBlock(blackberry_block);
      //.........bricks
          net.minecraft.world.level.block.Block blackberry_bricks_block = foodblockcompatregistry.BLACKBERRY_BRICKS_BLOCK.get();
          simpleBlock(blackberry_bricks_block);
      //.........chiseled
          net.minecraft.world.level.block.Block blackberry_chiseled_block = foodblockcompatregistry.BLACKBERRY_CHISELED_BLOCK.get();
          simpleBlock(blackberry_chiseled_block);
      //.........tiles
    ...
    public void buildSlabModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
      //.........plain
          SlabBlock banana_slab = foodblockcompatregistry.BANANA_SLAB.get();
          slabBlock(banana_slab, banana_block_texture, banana_block_texture);
      //.........bricks
          SlabBlock banana_bricks_slab = foodblockcompatregistry.BANANA_BRICKS_SLAB.get();
          slabBlock(banana_bricks_slab, banana_bricks_block_texture, banana_bricks_block_texture);
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
      //.........plain
          SlabBlock starfruit_slab = foodblockcompatregistry.STARFRUIT_SLAB.get();
          slabBlock(starfruit_slab, starfruit_block_texture, starfruit_block_texture);
      //.........bricks
    ...
    public void buildStairsModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
      //.........plain
          StairBlock banana_stairs = foodblockcompatregistry.BANANA_STAIRS.get();
          stairsBlock(banana_stairs, banana_block_texture);
      //.........bricks
          StairBlock banana_bricks_stairs = foodblockcompatregistry.BANANA_BRICKS_STAIRS.get();
          stairsBlock(banana_bricks_stairs, banana_bricks_block_texture);
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
      //.........plain
          StairBlock starfruit_stairs = foodblockcompatregistry.STARFRUIT_STAIRS.get();
          stairsBlock(starfruit_stairs, starfruit_block_texture);
      //.........bricks
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
      //.........plain
          ...
          stairsBlock(blackberry_stairs, blackberry_block_texture);
      //.........bricks
    ...
    public void buildBarsModels() {
     ...
     //--------------------------------------------------------------banana-------------------------------------------------------------------------
          IronBarsBlock banana_bars = foodblockcompatregistry.BANANA_BARS.get(); 
          ResourceLocation banana_bars_texture = modLoc("block/banana_bars");
          ResourceLocation banana_bars_rim_texture = modLoc("block/banana_block");
          paneBlockWithRenderType(banana_bars, "banana_bars", banana_bars_texture, banana_bars_rim_texture, "cutout_mipped_all"); 
     //------------------------------------------------------------starfruit------------------------------------------------------------------------
          IronBarsBlock starfruit_bars = foodblockcompatregistry.STARFRUIT_BARS.get(); 
    ...
    public void buildDoorModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          DoorBlock banana_door = foodblockcompatregistry.BANANA_DOOR.get(); 
          ResourceLocation banana_door_top_texture = modLoc("block/banana_door_top");
          ResourceLocation banana_door_bottom_texture = modLoc("block/banana_door_bottom");
          doorBlockWithRenderType(banana_door, "banana_door", banana_door_bottom_texture, banana_door_top_texture, "cutout_mipped_all"); 
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
          DoorBlock starfruit_door = foodblockcompatregistry.STARFRUIT_DOOR.get(); 
    ...
    public void buildButtonModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          ButtonBlock banana_button = foodblockcompatregistry.BANANA_BUTTON.get();
          ResourceLocation banana_button_texture = modLoc("block/banana_block");
          buttonBlock(banana_button, banana_button_texture);
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
    ...
    public void buildFenceAndGateModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
       //fence
          FenceBlock banana_fence = foodblockcompatregistry.BANANA_FENCE.get();
          ResourceLocation banana_fence_texture = modLoc("block/banana_block");
          fenceBlock(banana_fence, banana_fence_texture);
       //gate
          FenceGateBlock banana_gate = foodblockcompatregistry.BANANA_GATE.get();
          ResourceLocation banana_gate_texture = modLoc("block/banana_block");
          fenceGateBlock(banana_gate, banana_gate_texture);
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
       //fence
          FenceBlock starfruit_fence = foodblockcompatregistry.STARFRUIT_FENCE.get();
          ResourceLocation starfruit_fence_texture = modLoc("block/starfruit_block");
          fenceBlock(starfruit_fence, starfruit_fence_texture);
       //gate
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
       //fence
          ...
          ResourceLocation blackberry_fence_texture = modLoc("block/blackberry_block");
          fenceBlock(blackberry_fence, blackberry_fence_texture);
       //gate
    ...
    public void buildPressurePlateModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          PressurePlateBlock banana_pressure_plate = foodblockcompatregistry.BANANA_PRESSURE_PLATE.get();
          ResourceLocation banana_pressure_plate_texture = modLoc("block/banana_block");
          pressurePlateBlock(banana_pressure_plate, banana_pressure_plate_texture);
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
    ...
    public void buildSignModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
           StandingSignBlock banana_sign = foodblockcompatregistry.BANANA_STANDING_SIGN.get();
           WallSignBlock banana_wall_sign = foodblockcompatregistry.BANANA_WALL_SIGN.get();
           ResourceLocation banana_sign_texture = modLoc("block/banana_block");
           signBlock(banana_sign, banana_wall_sign, banana_sign_texture);
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
           StandingSignBlock starfruit_sign = foodblockcompatregistry.STARFRUIT_STANDING_SIGN.get();
    ...
    public void buildTrapdoorModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          TrapDoorBlock banana_trapdoor = foodblockcompatregistry.BANANA_TRAPDOOR.get(); 
          ResourceLocation banana_trapdoor_texture = modLoc("block/banana_block");
          trapdoorBlockWithRenderType(banana_trapdoor, "banana_trapdoor", banana_trapdoor_texture, false, banana_trapdoor_texture);
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
    ...
    public void buildLampModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          Block banana_lamp = foodblockcompatregistry.BANANA_LAMP.get();
          simpleBlock(banana_lamp);
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
    ...
    public void buildCarpetModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          CarpetBlock banana_carpet = foodblockcompatregistry.BANANA_CARPET.get();
          ResourceLocation banana_carpet_texture = modLoc("block/banana_carpet");
          BlockModelBuilder banana_carpet_model = models().withExistingParent(BuiltInRegistries.BLOCK.getKey(banana_carpet).getPath(), mcLoc("block/carpet"))
          .texture("wool", banana_carpet_texture);
          simpleBlock(banana_carpet, new ModelFile.UncheckedModelFile(banana_carpet_model.getLocation()));
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
          CarpetBlock starfruit_carpet = foodblockcompatregistry.STARFRUIT_CARPET.get();
    ...
    public void buildLanternModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
         //regular
          LanternBlock banana_lantern = foodblockcompatregistry.BANANA_LANTERN.get();
          ResourceLocation banana_lantern_texture = modLoc("block/banana_lantern");
  
          BlockModelBuilder banana_lantern_model = models()
              .withExistingParent("banana_lantern", mcLoc("block/lantern"))
              .renderType("cutout_mipped_all")
              .texture("lantern", banana_lantern_texture);
  
          BlockModelBuilder hanging_banana_lantern_model = models()
              .withExistingParent("banana_hanging_lantern", mcLoc("block/template_hanging_lantern"))
              .renderType("cutout_mipped_all")
              .texture("lantern", banana_lantern_texture);
  
          getVariantBuilder(banana_lantern)
              .partialState().with(LanternBlock.HANGING, true)
              .modelForState().modelFile(hanging_banana_lantern_model).addModel()
              .partialState().with(LanternBlock.HANGING, false)
              .modelForState().modelFile(banana_lantern_model).addModel();
         //soul
         LanternBlock banana_soul_lantern = foodblockcompatregistry.BANANA_SOUL_LANTERN.get();
         ResourceLocation banana_soul_lantern_texture = modLoc("block/banana_soul_lantern");
 
         BlockModelBuilder banana_soul_lantern_model = models()
             .withExistingParent("banana_soul_lantern", mcLoc("block/lantern"))
             .renderType("cutout_mipped_all")
             .texture("lantern", banana_soul_lantern_texture);
 
         BlockModelBuilder hanging_banana_soul_lantern_model = models()
             .withExistingParent("banana_soul_hanging_lantern", mcLoc("block/template_hanging_lantern"))
             .renderType("cutout_mipped_all")
             .texture("lantern", banana_soul_lantern_texture);
 
         getVariantBuilder(banana_soul_lantern)
             .partialState().with(LanternBlock.HANGING, true)
             .modelForState().modelFile(hanging_banana_soul_lantern_model).addModel()
             .partialState().with(LanternBlock.HANGING, false)
             .modelForState().modelFile(banana_soul_lantern_model).addModel();
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
         //regular
          LanternBlock starfruit_lantern = foodblockcompatregistry.STARFRUIT_LANTERN.get();
          ResourceLocation starfruit_lantern_texture = modLoc("block/starfruit_lantern");
  
          BlockModelBuilder starfruit_lantern_model = models()
              .withExistingParent("starfruit_lantern", mcLoc("block/lantern"))
              .renderType("cutout_mipped_all")
              .texture("lantern", starfruit_lantern_texture);
  
          BlockModelBuilder hanging_starfruit_lantern_model = models()
              .withExistingParent("starfruit_hanging_lantern", mcLoc("block/template_hanging_lantern"))
              .renderType("cutout_mipped_all")
              .texture("lantern", starfruit_lantern_texture);
  
          getVariantBuilder(starfruit_lantern)
              .partialState().with(LanternBlock.HANGING, true)
              .modelForState().modelFile(hanging_starfruit_lantern_model).addModel()
              .partialState().with(LanternBlock.HANGING, false)
              .modelForState().modelFile(starfruit_lantern_model).addModel();
         //soul
         LanternBlock starfruit_soul_lantern = foodblockcompatregistry.STARFRUIT_SOUL_LANTERN.get();
         ResourceLocation starfruit_soul_lantern_texture = modLoc("block/starfruit_soul_lantern");
 
         BlockModelBuilder starfruit_soul_lantern_model = models()
             .withExistingParent("starfruit_soul_lantern", mcLoc("block/lantern"))
             .renderType("cutout_mipped_all")
             .texture("lantern", starfruit_soul_lantern_texture);
 
         BlockModelBuilder hanging_starfruit_soul_lantern_model = models()
             .withExistingParent("starfruit_soul_hanging_lantern", mcLoc("block/template_hanging_lantern"))
             .renderType("cutout_mipped_all")
             .texture("lantern", starfruit_soul_lantern_texture);
 
         getVariantBuilder(starfruit_soul_lantern)
             .partialState().with(LanternBlock.HANGING, true)
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
         //regular
          ...
          ResourceLocation blackberry_lantern_texture = modLoc("block/blackberry_lantern");
  
          BlockModelBuilder blackberry_lantern_model = models()
              .withExistingParent("blackberry_lantern", mcLoc("block/lantern"))
              .renderType("cutout_mipped_all")
              .texture("lantern", blackberry_lantern_texture);
  
          BlockModelBuilder hanging_blackberry_lantern_model = models()
              .withExistingParent("blackberry_hanging_lantern", mcLoc("block/template_hanging_lantern"))
              .renderType("cutout_mipped_all")
              .texture("lantern", blackberry_lantern_texture);
  
          getVariantBuilder(blackberry_lantern)
              .partialState().with(LanternBlock.HANGING, true)
              .modelForState().modelFile(hanging_blackberry_lantern_model).addModel()
              .partialState().with(LanternBlock.HANGING, false)
              .modelForState().modelFile(blackberry_lantern_model).addModel();
         //soul
         LanternBlock blackberry_soul_lantern = foodblockcompatregistry.BLACKBERRY_SOUL_LANTERN.get();
         ResourceLocation blackberry_soul_lantern_texture = modLoc("block/blackberry_soul_lantern");
 
         BlockModelBuilder blackberry_soul_lantern_model = models()
             .withExistingParent("blackberry_soul_lantern", mcLoc("block/lantern"))
             .renderType("cutout_mipped_all")
             .texture("lantern", blackberry_soul_lantern_texture);
 
         BlockModelBuilder hanging_blackberry_soul_lantern_model = models()
             .withExistingParent("blackberry_soul_hanging_lantern", mcLoc("block/template_hanging_lantern"))
             .renderType("cutout_mipped_all")
             .texture("lantern", blackberry_soul_lantern_texture);
 
         getVariantBuilder(blackberry_soul_lantern)
             .partialState().with(LanternBlock.HANGING, true)
    ...
    public void buildChainModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
         ChainBlock banana_chain = foodblockcompatregistry.BANANA_CHAIN.get();
         ResourceLocation banana_chain_texture = modLoc("block/banana_chain");
         BlockModelBuilder banana_chain_model = models()
          .withExistingParent("banana_chain", mcLoc("block/chain"))
          .renderType("cutout_mipped_all")
          .texture("all", banana_chain_texture)
          .texture("particle", banana_chain_texture);

          getVariantBuilder(banana_chain)
          .partialState().with(BlockStateProperties.AXIS, Direction.Axis.Y)
          .modelForState().modelFile(banana_chain_model).addModel()
          .partialState().with(BlockStateProperties.AXIS, Direction.Axis.X)
          .modelForState().modelFile(banana_chain_model).rotationX(90).rotationY(90).addModel()
          .partialState().with(BlockStateProperties.AXIS, Direction.Axis.Z)
          .modelForState().modelFile(banana_chain_model).rotationX(90).addModel(); 
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
         ChainBlock starfruit_chain = foodblockcompatregistry.STARFRUIT_CHAIN.get();
         ResourceLocation starfruit_chain_texture = modLoc("block/starfruit_chain");
         BlockModelBuilder starfruit_chain_model = models()
          .withExistingParent("starfruit_chain", mcLoc("block/chain"))
          .renderType("cutout_mipped_all")
          .texture("all", starfruit_chain_texture)
          .texture("particle", starfruit_chain_texture);

          getVariantBuilder(starfruit_chain)
          .partialState().with(BlockStateProperties.AXIS, Direction.Axis.Y)
          .modelForState().modelFile(starfruit_chain_model).addModel()
          .partialState().with(BlockStateProperties.AXIS, Direction.Axis.X)
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
         ...
         BlockModelBuilder blackberry_chain_model = models()
          .withExistingParent("blackberry_chain", mcLoc("block/chain"))
          .renderType("cutout_mipped_all")
          .texture("all", blackberry_chain_texture)
          .texture("particle", blackberry_chain_texture);

          getVariantBuilder(blackberry_chain)
          .partialState().with(BlockStateProperties.AXIS, Direction.Axis.Y)
          .modelForState().modelFile(blackberry_chain_model).addModel()
          .partialState().with(BlockStateProperties.AXIS, Direction.Axis.X)
    ...
    public void buildLadderModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          LadderBlock bananaladder = foodblockcompatregistry.BANANA_LADDER.get();

          getVariantBuilder(bananaladder)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
              ...
              ResourceLocation modelLocation = modLoc("block/banana_ladder");
     ...
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
          LadderBlock starfruitladder = foodblockcompatregistry.STARFRUIT_LADDER.get();

          getVariantBuilder(starfruitladder)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
          LadderBlock blackberryladder = foodblockcompatregistry.BLACKBERRY_LADDER.get();

          getVariantBuilder(blackberryladder)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
    ...
    public void buildTableModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          HorizontalDirectionalBlock bananatable = foodblockcompatregistry.BANANA_TABLE.get();

          getVariantBuilder(bananatable)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
              ...
              ResourceLocation modelLocation = modLoc("block/banana_table");
     ...
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
          HorizontalDirectionalBlock starfruittable = foodblockcompatregistry.STARFRUIT_TABLE.get();

          getVariantBuilder(starfruittable)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
          HorizontalDirectionalBlock blackberrytable = foodblockcompatregistry.BLACKBERRY_TABLE.get();

          getVariantBuilder(blackberrytable)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
    ...
    public void buildTorchModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
       //regular
        TorchBlock banana_torch = foodblockcompatregistry.BANANA_TORCH.get();
        ResourceLocation banana_torch_texture = modLoc("block/banana_torch");
        BlockModelBuilder banana_torch_model = models()
        .withExistingParent("banana_torch", mcLoc("block/torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", banana_torch_texture)
        .texture("particle", banana_torch_texture);

        simpleBlock(banana_torch, banana_torch_model);

        TorchBlock banana_wall_torch = foodblockcompatregistry.BANANA_WALL_TORCH.get();
        BlockModelBuilder banana_wall_torch_model = models()
        .withExistingParent("banana_wall_torch", mcLoc("block/wall_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", banana_torch_texture)
        .texture("particle", banana_torch_texture);
        getVariantBuilder(banana_wall_torch)
        .forAllStates(state -> {
            Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
            int rotation = switch (facing) {
                case NORTH -> 270;
            ...
            return ConfiguredModel.builder()
                .modelFile(models().withExistingParent("banana_wall_torch", mcLoc("block/wall_torch"))
                    .renderType("cutout_mipped_all")
                    .texture("torch", banana_torch_texture)
                    .texture("particle", banana_torch_texture))
                .rotationY(rotation)
       ...
       //redstone
        RedstoneTorchBlock banana_redstone_torch = foodblockcompatregistry.BANANA_REDSTONE_TORCH.get();
        ResourceLocation banana_redstone_torch_texture = modLoc("block/banana_redstone_torch");
        BlockModelBuilder banana_redstone_torch_model = models()
        .withExistingParent("banana_redstone_torch", mcLoc("block/redstone_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", banana_redstone_torch_texture)
        .texture("particle", banana_redstone_torch_texture);
        

        simpleBlock(banana_redstone_torch, banana_redstone_torch_model);

        ResourceLocation banana_redstone_wall_torch_texture = modLoc("block/banana_redstone_torch");

        RedstoneTorchBlock banana_redstone_wall_torch = foodblockcompatregistry.BANANA_REDSTONE_WALL_TORCH.get();
        BlockModelBuilder banana_redstone_wall_torch_model = models()
        .withExistingParent("banana_redstone_wall_torch", mcLoc("block/wall_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", banana_redstone_wall_torch_texture)
        .texture("particle", banana_redstone_wall_torch_texture);
        getVariantBuilder(banana_redstone_wall_torch)
        .forAllStates(state -> {
            Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
            int rotation = switch (facing) {
                case NORTH -> 270;
            ...
            return ConfiguredModel.builder()
                .modelFile(models().withExistingParent("banana_redstone_wall_torch_model", mcLoc("block/wall_torch"))
                    .renderType("cutout_mipped_all")
                    .texture("torch", banana_redstone_wall_torch_texture)
                    .texture("particle", banana_redstone_wall_torch_texture))
                .rotationY(rotation)
       ...
       //soul
        TorchBlock banana_soul_torch = foodblockcompatregistry.BANANA_SOUL_TORCH.get();
        ResourceLocation banana_soul_torch_texture = modLoc("block/banana_soul_torch");
        BlockModelBuilder banana_soul_torch_model = models()
        .withExistingParent("banana_soul_torch", mcLoc("block/soul_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", banana_soul_torch_texture)
        .texture("particle", banana_soul_torch_texture);
        

        simpleBlock(banana_soul_torch, banana_soul_torch_model);

        ResourceLocation banana_soul_wall_torch_texture = modLoc("block/banana_soul_torch");
        TorchBlock banana_soul_wall_torch = foodblockcompatregistry.BANANA_SOUL_WALL_TORCH.get();
        BlockModelBuilder banana_soul_wall_torch_model = models()
        .withExistingParent("banana_soul_wall_torch", mcLoc("block/wall_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", banana_soul_wall_torch_texture)
        .texture("particle", banana_soul_wall_torch_texture);
        getVariantBuilder(banana_soul_wall_torch)
        .forAllStates(state -> {
            Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
            int rotation = switch (facing) {
                case NORTH -> 270;
            ...
            return ConfiguredModel.builder()
                .modelFile(models().withExistingParent("banana_soul_wall_torch_model", mcLoc("block/wall_torch"))
                    .renderType("cutout_mipped_all")
                    .texture("torch", banana_soul_wall_torch_texture)
                    .texture("particle", banana_soul_wall_torch_texture))
                .rotationY(rotation)
     ...
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
       //regular
        TorchBlock starfruit_torch = foodblockcompatregistry.STARFRUIT_TORCH.get();
        ResourceLocation starfruit_torch_texture = modLoc("block/starfruit_torch");
        BlockModelBuilder starfruit_torch_model = models()
        .withExistingParent("starfruit_torch", mcLoc("block/torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", starfruit_torch_texture)
        .texture("particle", starfruit_torch_texture);

        simpleBlock(starfruit_torch, starfruit_torch_model);

        TorchBlock starfruit_wall_torch = foodblockcompatregistry.STARFRUIT_WALL_TORCH.get();
        BlockModelBuilder starfruit_wall_torch_model = models()
        .withExistingParent("starfruit_wall_torch", mcLoc("block/wall_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", starfruit_torch_texture)
        .texture("particle", starfruit_torch_texture);
        getVariantBuilder(starfruit_wall_torch)
        .forAllStates(state -> {
            Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
            int rotation = switch (facing) {
                case NORTH -> 270;
            ...
            return ConfiguredModel.builder()
                .modelFile(models().withExistingParent("starfruit_wall_torch", mcLoc("block/wall_torch"))
                    .renderType("cutout_mipped_all")
                    .texture("torch", starfruit_torch_texture)
                    .texture("particle", starfruit_torch_texture))
                .rotationY(rotation)
       ...
       //redstone
        RedstoneTorchBlock starfruit_redstone_torch = foodblockcompatregistry.STARFRUIT_REDSTONE_TORCH.get();
        ResourceLocation starfruit_redstone_torch_texture = modLoc("block/starfruit_redstone_torch");
        BlockModelBuilder starfruit_redstone_torch_model = models()
        .withExistingParent("starfruit_redstone_torch", mcLoc("block/redstone_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", starfruit_redstone_torch_texture)
        .texture("particle", starfruit_redstone_torch_texture);
        

        simpleBlock(starfruit_redstone_torch, starfruit_redstone_torch_model);

        ResourceLocation starfruit_redstone_wall_torch_texture = modLoc("block/starfruit_redstone_torch");

        RedstoneTorchBlock starfruit_redstone_wall_torch = foodblockcompatregistry.STARFRUIT_REDSTONE_WALL_TORCH.get();
        BlockModelBuilder starfruit_redstone_wall_torch_model = models()
        .withExistingParent("starfruit_redstone_wall_torch", mcLoc("block/wall_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", starfruit_redstone_wall_torch_texture)
        .texture("particle", starfruit_redstone_wall_torch_texture);
        getVariantBuilder(starfruit_redstone_wall_torch)
        .forAllStates(state -> {
            Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
            int rotation = switch (facing) {
                case NORTH -> 270;
            ...
            return ConfiguredModel.builder()
                .modelFile(models().withExistingParent("starfruit_redstone_wall_torch_model", mcLoc("block/wall_torch"))
                    .renderType("cutout_mipped_all")
                    .texture("torch", starfruit_redstone_wall_torch_texture)
                    .texture("particle", starfruit_redstone_wall_torch_texture))
                .rotationY(rotation)
       ...
       //soul
        TorchBlock starfruit_soul_torch = foodblockcompatregistry.STARFRUIT_SOUL_TORCH.get();
        ResourceLocation starfruit_soul_torch_texture = modLoc("block/starfruit_soul_torch");
        BlockModelBuilder starfruit_soul_torch_model = models()
        .withExistingParent("starfruit_soul_torch", mcLoc("block/soul_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", starfruit_soul_torch_texture)
        .texture("particle", starfruit_soul_torch_texture);
        

        simpleBlock(starfruit_soul_torch, starfruit_soul_torch_model);

        ResourceLocation starfruit_soul_wall_torch_texture = modLoc("block/starfruit_soul_torch");
        TorchBlock starfruit_soul_wall_torch = foodblockcompatregistry.STARFRUIT_SOUL_WALL_TORCH.get();
        BlockModelBuilder starfruit_soul_wall_torch_model = models()
        .withExistingParent("starfruit_soul_wall_torch", mcLoc("block/wall_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", starfruit_soul_wall_torch_texture)
        .texture("particle", starfruit_soul_wall_torch_texture);
        getVariantBuilder(starfruit_soul_wall_torch)
        .forAllStates(state -> {
            Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
            int rotation = switch (facing) {
                case NORTH -> 270;
            ...
            return ConfiguredModel.builder()
                .modelFile(models().withExistingParent("starfruit_soul_wall_torch_model", mcLoc("block/wall_torch"))
                    .renderType("cutout_mipped_all")
                    .texture("torch", starfruit_soul_wall_torch_texture)
                    .texture("particle", starfruit_soul_wall_torch_texture))
                .rotationY(rotation)
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
       //regular
        TorchBlock blackberry_torch = foodblockcompatregistry.BLACKBERRY_TORCH.get();
        ResourceLocation blackberry_torch_texture = modLoc("block/blackberry_torch");
        BlockModelBuilder blackberry_torch_model = models()
        .withExistingParent("blackberry_torch", mcLoc("block/torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", blackberry_torch_texture)
        .texture("particle", blackberry_torch_texture);

        simpleBlock(blackberry_torch, blackberry_torch_model);

        TorchBlock blackberry_wall_torch = foodblockcompatregistry.BLACKBERRY_WALL_TORCH.get();
        BlockModelBuilder blackberry_wall_torch_model = models()
        .withExistingParent("blackberry_wall_torch", mcLoc("block/wall_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", blackberry_torch_texture)
        .texture("particle", blackberry_torch_texture);
        getVariantBuilder(blackberry_wall_torch)
        .forAllStates(state -> {
            Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
            int rotation = switch (facing) {
                case NORTH -> 270;
            ...
            return ConfiguredModel.builder()
                .modelFile(models().withExistingParent("blackberry_wall_torch", mcLoc("block/wall_torch"))
                    .renderType("cutout_mipped_all")
                    .texture("torch", blackberry_torch_texture)
                    .texture("particle", blackberry_torch_texture))
                .rotationY(rotation)
       ...
       //redstone
        RedstoneTorchBlock blackberry_redstone_torch = foodblockcompatregistry.BLACKBERRY_REDSTONE_TORCH.get();
        ResourceLocation blackberry_redstone_torch_texture = modLoc("block/blackberry_redstone_torch");
        BlockModelBuilder blackberry_redstone_torch_model = models()
        .withExistingParent("blackberry_redstone_torch", mcLoc("block/redstone_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", blackberry_redstone_torch_texture)
        .texture("particle", blackberry_redstone_torch_texture);
        

        simpleBlock(blackberry_redstone_torch, blackberry_redstone_torch_model);

        ResourceLocation blackberry_redstone_wall_torch_texture = modLoc("block/blackberry_redstone_torch");

        RedstoneTorchBlock blackberry_redstone_wall_torch = foodblockcompatregistry.BLACKBERRY_REDSTONE_WALL_TORCH.get();
        BlockModelBuilder blackberry_redstone_wall_torch_model = models()
        .withExistingParent("blackberry_redstone_wall_torch", mcLoc("block/wall_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", blackberry_redstone_wall_torch_texture)
        .texture("particle", blackberry_redstone_wall_torch_texture);
        getVariantBuilder(blackberry_redstone_wall_torch)
        .forAllStates(state -> {
            Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
            int rotation = switch (facing) {
                case NORTH -> 270;
            ...
            return ConfiguredModel.builder()
                .modelFile(models().withExistingParent("blackberry_redstone_wall_torch_model", mcLoc("block/wall_torch"))
                    .renderType("cutout_mipped_all")
                    .texture("torch", blackberry_redstone_wall_torch_texture)
                    .texture("particle", blackberry_redstone_wall_torch_texture))
                .rotationY(rotation)
       ...
       //soul
        TorchBlock blackberry_soul_torch = foodblockcompatregistry.BLACKBERRY_SOUL_TORCH.get();
        ResourceLocation blackberry_soul_torch_texture = modLoc("block/blackberry_soul_torch");
        BlockModelBuilder blackberry_soul_torch_model = models()
        .withExistingParent("blackberry_soul_torch", mcLoc("block/soul_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", blackberry_soul_torch_texture)
        .texture("particle", blackberry_soul_torch_texture);
        

        simpleBlock(blackberry_soul_torch, blackberry_soul_torch_model);

        ResourceLocation blackberry_soul_wall_torch_texture = modLoc("block/blackberry_soul_torch");
        TorchBlock blackberry_soul_wall_torch = foodblockcompatregistry.BLACKBERRY_SOUL_WALL_TORCH.get();
        BlockModelBuilder blackberry_soul_wall_torch_model = models()
        .withExistingParent("blackberry_soul_wall_torch", mcLoc("block/wall_torch"))
        .renderType("cutout_mipped_all")
        .texture("torch", blackberry_soul_wall_torch_texture)
        .texture("particle", blackberry_soul_wall_torch_texture);
        getVariantBuilder(blackberry_soul_wall_torch)
        .forAllStates(state -> {
            Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
            int rotation = switch (facing) {
                case NORTH -> 270;
            ...
            return ConfiguredModel.builder()
                .modelFile(models().withExistingParent("blackberry_soul_wall_torch_model", mcLoc("block/wall_torch"))
                    .renderType("cutout_mipped_all")
                    .texture("torch", blackberry_soul_wall_torch_texture)
                    .texture("particle", blackberry_soul_wall_torch_texture))
                .rotationY(rotation)
    ...
    public void buildFurnaceModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          FurnaceBlock banana_furnace = foodblockcompatregistry.BANANA_FURNACE.get();
          ResourceLocation banana_furnace_unlit_texture = modLoc("block/banana_furnace");
          ResourceLocation banana_furnace_lit_texture = modLoc("block/banana_furnace_lit");
          ResourceLocation banana_furnace_side = modLoc("block/banana_block");
          
          BlockModelBuilder banana_furnace_model_unlit = models()
              .withExistingParent("banana_furnace_model_unlit", mcLoc("block/furnace"))
              .renderType("cutout_mipped_all")
              .texture("side", banana_furnace_side)
              .texture("top", banana_furnace_side)
              .texture("front", banana_furnace_unlit_texture)
              .texture("particle", banana_furnace_side);
          
          BlockModelBuilder banana_furnace_model_lit = models()
              .withExistingParent("banana_furnace_model_lit", mcLoc("block/furnace"))
              .renderType("cutout_mipped_all")
              .texture("side", banana_furnace_side)
              .texture("top", banana_furnace_side)
              .texture("front", banana_furnace_lit_texture)
              .texture("particle", banana_furnace_side);
          
          getVariantBuilder(banana_furnace)
              .forAllStates(state -> {
                  Boolean lit = state.getValue(BlockStateProperties.LIT);
                  Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                  int rotation = switch (facing) {
                  ...
                  ResourceLocation modelLocation = lit ? modLoc("block/banana_furnace_model_lit") : modLoc("block/banana_furnace_model_unlit");
     ...
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
          FurnaceBlock starfruit_furnace = foodblockcompatregistry.STARFRUIT_FURNACE.get();
          ResourceLocation starfruit_furnace_unlit_texture = modLoc("block/starfruit_furnace");
          ResourceLocation starfruit_furnace_lit_texture = modLoc("block/starfruit_furnace_lit");
          ResourceLocation starfruit_furnace_side = modLoc("block/starfruit_block");
          
          BlockModelBuilder starfruit_furnace_model_unlit = models()
              .withExistingParent("starfruit_furnace_model_unlit", mcLoc("block/furnace"))
              .renderType("cutout_mipped_all")
              .texture("side", starfruit_furnace_side)
              .texture("top", starfruit_furnace_side)
              .texture("front", starfruit_furnace_unlit_texture)
              .texture("particle", starfruit_furnace_side);
          
          BlockModelBuilder starfruit_furnace_model_lit = models()
              .withExistingParent("starfruit_furnace_model_lit", mcLoc("block/furnace"))
              .renderType("cutout_mipped_all")
              .texture("side", starfruit_furnace_side)
              .texture("top", starfruit_furnace_side)
              .texture("front", starfruit_furnace_lit_texture)
              .texture("particle", starfruit_furnace_side);
          
          getVariantBuilder(starfruit_furnace)
              .forAllStates(state -> {
                  Boolean lit = state.getValue(BlockStateProperties.LIT);
                  Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                  int rotation = switch (facing) {
                  ...
                  ResourceLocation modelLocation = lit ? modLoc("block/starfruit_furnace_model_lit") : modLoc("block/starfruit_furnace_model_unlit");
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
          ...
          ResourceLocation blackberry_furnace_lit_texture = modLoc("block/blackberry_furnace_lit");
          ResourceLocation blackberry_furnace_side = modLoc("block/blackberry_block");
          
          // Define the model for the unlit state
          BlockModelBuilder blackberry_furnace_model_unlit = models()
              .withExistingParent("blackberry_furnace_model_unlit", mcLoc("block/furnace"))
              .renderType("cutout_mipped_all")
              .texture("side", blackberry_furnace_side)
              .texture("top", blackberry_furnace_side)
              .texture("front", blackberry_furnace_unlit_texture)
              .texture("particle", blackberry_furnace_side);
          
          // Define the model for the lit state
          BlockModelBuilder blackberry_furnace_model_lit = models()
              .withExistingParent("blackberry_furnace_model_lit", mcLoc("block/furnace"))
              .renderType("cutout_mipped_all")
              .texture("side", blackberry_furnace_side)
              .texture("top", blackberry_furnace_side)
              .texture("front", blackberry_furnace_lit_texture)
              .texture("particle", blackberry_furnace_side);
          
          // Configure variants for the blackberry_furnace block
          getVariantBuilder(blackberry_furnace)
              .forAllStates(state -> {
                  Boolean lit = state.getValue(BlockStateProperties.LIT);
                  Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
                  int rotation = switch (facing) {
                  ...
                  ResourceLocation modelLocation = lit ? modLoc("block/blackberry_furnace_model_lit") : modLoc("block/blackberry_furnace_model_unlit");
    ...
    public void buildPathModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          foodpathtypeminislab banana_stone_path = foodblockcompatregistry.BANANA_STONE_PATH.get();

          getVariantBuilder(banana_stone_path)
          .forAllStates(state -> {

              ResourceLocation modelLocation = modLoc("block/banana_stone_path");
     ...
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
          foodpathtypeminislab starfruit_stone_path = foodblockcompatregistry.STARFRUIT_STONE_PATH.get();

          getVariantBuilder(starfruit_stone_path)
          .forAllStates(state -> {

              ResourceLocation modelLocation = modLoc("block/starfruit_stone_path");
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
          ...
          getVariantBuilder(blackberry_stone_path)
          .forAllStates(state -> {

              ResourceLocation modelLocation = modLoc("block/blackberry_stone_path");
    ...
    public void buildBarrelModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          compatFoodBarrel banana_barrel = foodblockcompatregistry.BANANA_BARREL.get();
          ResourceLocation banana_barrel_closed_texture = modLoc("block/banana_barrel_top_closed");
          ResourceLocation banana_barrel_open_texture = modLoc("block/banana_barrel_top_open");
          ResourceLocation banana_barrel_side = modLoc("block/banana_barrel_side");
          ResourceLocation banana_barrel_bottom = modLoc("block/banana_barrel_bottom");
          
          BlockModelBuilder banana_barrel_model_closed = models()
              .withExistingParent("banana_barrel_model_closed", mcLoc("block/barrel"))
              .renderType("cutout_mipped_all")
              .texture("side", banana_barrel_side)
              .texture("bottom", banana_barrel_bottom)
              .texture("top", banana_barrel_closed_texture)
              .texture("particle", banana_barrel_side);
          
          BlockModelBuilder banana_barrel_model_open = models()
              .withExistingParent("banana_barrel_model_open", mcLoc("block/barrel"))
              .renderType("cutout_mipped_all")
              .texture("side", banana_barrel_side)
              .texture("bottom", banana_barrel_bottom)
              .texture("top", banana_barrel_open_texture)
              .texture("particle", banana_barrel_side);
          
          getVariantBuilder(banana_barrel)
              .forAllStates(state -> {
                  Boolean open = state.getValue(BlockStateProperties.OPEN);
                  Direction facing = state.getValue(BlockStateProperties.FACING);
                  int rotationY = switch (facing) {
                  ...
                  ResourceLocation modelLocation = open ? modLoc("block/banana_barrel_model_open") : modLoc("block/banana_barrel_model_closed");
     ...
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
          compatFoodBarrel starfruit_barrel = foodblockcompatregistry.STARFRUIT_BARREL.get();
          ResourceLocation starfruit_barrel_closed_texture = modLoc("block/starfruit_barrel_top_closed");
          ResourceLocation starfruit_barrel_open_texture = modLoc("block/starfruit_barrel_top_open");
          ResourceLocation starfruit_barrel_side = modLoc("block/starfruit_barrel_side");
          ResourceLocation starfruit_barrel_bottom = modLoc("block/starfruit_barrel_bottom");
          
          BlockModelBuilder starfruit_barrel_model_closed = models()
              .withExistingParent("starfruit_barrel_model_closed", mcLoc("block/barrel"))
              .renderType("cutout_mipped_all")
              .texture("side", starfruit_barrel_side)
              .texture("bottom", starfruit_barrel_bottom)
              .texture("top", starfruit_barrel_closed_texture)
              .texture("particle", starfruit_barrel_side);
          
          BlockModelBuilder starfruit_barrel_model_open = models()
              .withExistingParent("starfruit_barrel_model_open", mcLoc("block/barrel"))
              .renderType("cutout_mipped_all")
              .texture("side", starfruit_barrel_side)
              .texture("bottom", starfruit_barrel_bottom)
              .texture("top", starfruit_barrel_open_texture)
              .texture("particle", starfruit_barrel_side);
          
          getVariantBuilder(starfruit_barrel)
              .forAllStates(state -> {
                  Boolean open = state.getValue(BlockStateProperties.OPEN);
                  Direction facing = state.getValue(BlockStateProperties.FACING);
                  int rotationY = switch (facing) {
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
          ...
          ResourceLocation blackberry_barrel_bottom = modLoc("block/blackberry_barrel_bottom");
          
          BlockModelBuilder blackberry_barrel_model_closed = models()
              .withExistingParent("blackberry_barrel_model_closed", mcLoc("block/barrel"))
              .renderType("cutout_mipped_all")
              .texture("side", blackberry_barrel_side)
              .texture("bottom", blackberry_barrel_bottom)
              .texture("top", blackberry_barrel_closed_texture)
              .texture("particle", blackberry_barrel_side);
          
          BlockModelBuilder blackberry_barrel_model_open = models()
              .withExistingParent("blackberry_barrel_model_open", mcLoc("block/barrel"))
              .renderType("cutout_mipped_all")
              .texture("side", blackberry_barrel_side)
              .texture("bottom", blackberry_barrel_bottom)
              .texture("top", blackberry_barrel_open_texture)
              .texture("particle", blackberry_barrel_side);
          
          getVariantBuilder(blackberry_barrel)
              .forAllStates(state -> {
                  Boolean open = state.getValue(BlockStateProperties.OPEN);
                  Direction facing = state.getValue(BlockStateProperties.FACING);
                  int rotationY = switch (facing) {
    ...
    public void buildChairModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          foodChairBlock bananaChair = foodblockcompatregistry.BANANA_CHAIR.get();

          getVariantBuilder(bananaChair)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
              ...
              ResourceLocation modelLocation = modLoc("block/banana_chair");
     ...
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
          foodChairBlock starfruitChair = foodblockcompatregistry.STARFRUIT_CHAIR.get();

          getVariantBuilder(starfruitChair)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
              ...
              ResourceLocation modelLocation = modLoc("block/starfruit_chair");
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
          ...
          getVariantBuilder(blackberryChair)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
              ...
              ResourceLocation modelLocation = modLoc("block/blackberry_chair");
    ...
    public void buildBedModels() {
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
          compatBed bananaBed = foodblockcompatregistry.BANANA_BED.get();

          getVariantBuilder(bananaBed)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
              ...
              ResourceLocation modelLocation = modLoc("block/banana_bed");
     ...
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
          compatBed starfruitBed = foodblockcompatregistry.STARFRUIT_BED.get();

          getVariantBuilder(starfruitBed)
          .forAllStates(state -> {
              Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
              int rotationY = switch (facing) {
                  case NORTH -> 180;
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
          ...
          .forAllStates(state -> {
              ...
              ResourceLocation modelLocation = modLoc("block/blackberry_bed");
    ...
    public void buildCabinetModels() {
     //------------------------------------------------------------elderberry-----------------------------------------------------------------------
         //small
         compatSmallFoodCabinet elderberryCabinet = foodblockcompatregistry.SMALL_ELDERBERRY_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet elderberryMediumCabinet = foodblockcompatregistry.MEDIUM_ELDERBERRY_CABINET.get();
     ...
     //------------------------------------------------------------juniper-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet juniperCabinet = foodblockcompatregistry.SMALL_JUNIPER_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet juniperMediumCabinet = foodblockcompatregistry.MEDIUM_JUNIPER_CABINET.get();
     ...
     //------------------------------------------------------------banana-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet bananaCabinet = foodblockcompatregistry.SMALL_BANANA_CABINET.get();

         getVariantBuilder(bananaCabinet)
         .forAllStates(state -> {
             Boolean open = state.getValue(BlockStateProperties.OPEN);
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             int rotationY = switch (facing) {
             ...
             ResourceLocation modelLocation = open ? modLoc("block/banana_cabinet_open") : modLoc("block/banana_cabinet");
        ...
        //medium
         compatMediumFoodCabinet bananaMediumCabinet = foodblockcompatregistry.MEDIUM_BANANA_CABINET.get();

         getVariantBuilder(bananaMediumCabinet)
         .forAllStates(state -> {
             Boolean open = state.getValue(BlockStateProperties.OPEN);
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             int rotationY = switch (facing) {
             ...
             ResourceLocation modelLocation = open ? modLoc("block/medium_banana_cabinet_open") : modLoc("block/medium_banana_cabinet");
     ...
     //------------------------------------------------------------starfruit-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet starfruitCabinet = foodblockcompatregistry.SMALL_STARFRUIT_CABINET.get();

         getVariantBuilder(starfruitCabinet)
         .forAllStates(state -> {
             Boolean open = state.getValue(BlockStateProperties.OPEN);
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             int rotationY = switch (facing) {
             ...
             ResourceLocation modelLocation = open ? modLoc("block/starfruit_cabinet_open") : modLoc("block/starfruit_cabinet");
        ...
        //medium
         compatMediumFoodCabinet starfruitMediumCabinet = foodblockcompatregistry.MEDIUM_STARFRUIT_CABINET.get();

         getVariantBuilder(starfruitMediumCabinet)
         .forAllStates(state -> {
             Boolean open = state.getValue(BlockStateProperties.OPEN);
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             int rotationY = switch (facing) {
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet blackberryCabinet = foodblockcompatregistry.SMALL_BLACKBERRY_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet blackberryMediumCabinet = foodblockcompatregistry.MEDIUM_BLACKBERRY_CABINET.get();
     ...
     //------------------------------------------------------------raspberry-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet raspberryCabinet = foodblockcompatregistry.SMALL_RASPBERRY_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet raspberryMediumCabinet = foodblockcompatregistry.MEDIUM_RASPBERRY_CABINET.get();
     ...
     //------------------------------------------------------------strawberry-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet strawberryCabinet = foodblockcompatregistry.SMALL_STRAWBERRY_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet strawberryMediumCabinet = foodblockcompatregistry.MEDIUM_STRAWBERRY_CABINET.get();
     ...
     //------------------------------------------------------------sugarapple-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet sugarappleCabinet = foodblockcompatregistry.SMALL_SUGARAPPLE_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet sugarappleMediumCabinet = foodblockcompatregistry.MEDIUM_SUGARAPPLE_CABINET.get();
     ...
     //------------------------------------------------------------cherry-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet cherryCabinet = foodblockcompatregistry.SMALL_CHERRY_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet cherryMediumCabinet = foodblockcompatregistry.MEDIUM_CHERRY_CABINET.get();
     ...
     //------------------------------------------------------------blackcherry-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet blackcherryCabinet = foodblockcompatregistry.SMALL_BLACKCHERRY_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet blackcherryMediumCabinet = foodblockcompatregistry.MEDIUM_BLACKCHERRY_CABINET.get();
     ...
     //------------------------------------------------------------peach-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet peachCabinet = foodblockcompatregistry.SMALL_PEACH_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet peachMediumCabinet = foodblockcompatregistry.MEDIUM_PEACH_CABINET.get();
     ...
     //------------------------------------------------------------coconut-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet coconutCabinet = foodblockcompatregistry.SMALL_COCONUT_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet coconutMediumCabinet = foodblockcompatregistry.MEDIUM_COCONUT_CABINET.get();
     ...
     //------------------------------------------------------------orange-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet orangeCabinet = foodblockcompatregistry.SMALL_ORANGE_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet orangeMediumCabinet = foodblockcompatregistry.MEDIUM_ORANGE_CABINET.get();
     ...
     //------------------------------------------------------------tangerine-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet tangerineCabinet = foodblockcompatregistry.SMALL_TANGERINE_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet tangerineMediumCabinet = foodblockcompatregistry.MEDIUM_TANGERINE_CABINET.get();
     ...
     //------------------------------------------------------------kumquat-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet kumquatCabinet = foodblockcompatregistry.SMALL_KUMQUAT_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet kumquatMediumCabinet = foodblockcompatregistry.MEDIUM_KUMQUAT_CABINET.get();
     ...
     //------------------------------------------------------------persimmon-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet persimmonCabinet = foodblockcompatregistry.SMALL_PERSIMMON_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet persimmonMediumCabinet = foodblockcompatregistry.MEDIUM_PERSIMMON_CABINET.get();
     ...
     //------------------------------------------------------------satsuma-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet satsumaCabinet = foodblockcompatregistry.SMALL_SATSUMA_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet satsumaMediumCabinet = foodblockcompatregistry.MEDIUM_SATSUMA_CABINET.get();
     ...
     //------------------------------------------------------------mandarin-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet mandarinCabinet = foodblockcompatregistry.SMALL_MANDARIN_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet mandarinMediumCabinet = foodblockcompatregistry.MEDIUM_MANDARIN_CABINET.get();
     ...
     //------------------------------------------------------------lemon-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet lemonCabinet = foodblockcompatregistry.SMALL_LEMON_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet lemonMediumCabinet = foodblockcompatregistry.MEDIUM_LEMON_CABINET.get();
     ...
     //------------------------------------------------------------citron-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet citronCabinet = foodblockcompatregistry.SMALL_CITRON_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet citronMediumCabinet = foodblockcompatregistry.MEDIUM_CITRON_CABINET.get();
     ...
     //------------------------------------------------------------buddhashand-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet buddhashandCabinet = foodblockcompatregistry.SMALL_BUDDHASHAND_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet buddhashandMediumCabinet = foodblockcompatregistry.MEDIUM_BUDDHASHAND_CABINET.get();
     ...
     //------------------------------------------------------------lime-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet limeCabinet = foodblockcompatregistry.SMALL_LIME_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet limeMediumCabinet = foodblockcompatregistry.MEDIUM_LIME_CABINET.get();
     ...
     //------------------------------------------------------------keylime-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet keylimeCabinet = foodblockcompatregistry.SMALL_KEYLIME_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet keylimeMediumCabinet = foodblockcompatregistry.MEDIUM_KEYLIME_CABINET.get();
     ...
     //------------------------------------------------------------fingerlime-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet fingerlimeCabinet = foodblockcompatregistry.SMALL_FINGERLIME_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet fingerlimeMediumCabinet = foodblockcompatregistry.MEDIUM_FINGERLIME_CABINET.get();
     ...
     //------------------------------------------------------------grapefruit-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet grapefruitCabinet = foodblockcompatregistry.SMALL_GRAPEFRUIT_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet grapefruitMediumCabinet = foodblockcompatregistry.MEDIUM_GRAPEFRUIT_CABINET.get();
     ...
     //------------------------------------------------------------pomelo-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet pomeloCabinet = foodblockcompatregistry.SMALL_POMELO_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet pomeloMediumCabinet = foodblockcompatregistry.MEDIUM_POMELO_CABINET.get();
     ...
     //------------------------------------------------------------corn-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet cornCabinet = foodblockcompatregistry.SMALL_CORN_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet cornMediumCabinet = foodblockcompatregistry.MEDIUM_CORN_CABINET.get();
     ...
     //------------------------------------------------------------onion-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet onionCabinet = foodblockcompatregistry.SMALL_ONION_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet onionMediumCabinet = foodblockcompatregistry.MEDIUM_ONION_CABINET.get();
     ...
     //------------------------------------------------------------tomato-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet tomatoCabinet = foodblockcompatregistry.SMALL_TOMATO_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet tomatoMediumCabinet = foodblockcompatregistry.MEDIUM_TOMATO_CABINET.get();
     ...
     //------------------------------------------------------------pecan-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet pecanCabinet = foodblockcompatregistry.SMALL_PECAN_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet pecanMediumCabinet = foodblockcompatregistry.MEDIUM_PECAN_CABINET.get();
     ...
     //------------------------------------------------------------almond-----------------------------------------------------------------------
        //small
         compatSmallFoodCabinet almondCabinet = foodblockcompatregistry.SMALL_ALMOND_CABINET.get();
        ...
        //medium
         compatMediumFoodCabinet almondMediumCabinet = foodblockcompatregistry.MEDIUM_ALMOND_CABINET.get();
    ...
    public void buildDeskModels() {
     ...
     //-------------------------------------------------------------juniper-------------------------------------------------------------------------
         ...
         .forAllStates(state -> {
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/juniper_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/juniper_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/juniper_desk_double_left");
             } else {
                modelLocation = modLoc("block/juniper_desk_double_right");
             }
     ...
     //--------------------------------------------------------------banana-------------------------------------------------------------------------
         ...
         .forAllStates(state -> {
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/banana_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/banana_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/banana_desk_double_left");
             } else {
                modelLocation = modLoc("block/banana_desk_double_right");
             }
     ...
     //------------------------------------------------------------starfruit------------------------------------------------------------------------
         ...
         .forAllStates(state -> {
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/starfruit_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/starfruit_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/starfruit_desk_double_left");
             } else {
                modelLocation = modLoc("block/starfruit_desk_double_right");
             }
     ...
     //------------------------------------------------------------kiwifruit------------------------------------------------------------------------
         ...
         .forAllStates(state -> {
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/kiwifruit_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/kiwifruit_desk_triple_center");
             } else if (isleft && !isright) {
     ...
     //------------------------------------------------------------blackberry-----------------------------------------------------------------------
         foodDeskCompat blackberryDesk = foodblockcompatregistry.BLACKBERRY_DESK.get();
         
         getVariantBuilder(blackberryDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/blackberry_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/blackberry_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/blackberry_desk_double_left");
             } else {
                modelLocation = modLoc("block/blackberry_desk_double_right");
             }
     ...
     //------------------------------------------------------------raspberry------------------------------------------------------------------------
         foodDeskCompat raspberryDesk = foodblockcompatregistry.RASPBERRY_DESK.get();
         
         getVariantBuilder(raspberryDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/raspberry_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/raspberry_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/raspberry_desk_double_left");
             } else {
                modelLocation = modLoc("block/raspberry_desk_double_right");
             }
     ...
     //------------------------------------------------------------strawberry-----------------------------------------------------------------------
         foodDeskCompat strawberryDesk = foodblockcompatregistry.STRAWBERRY_DESK.get();
         
         getVariantBuilder(strawberryDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/strawberry_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/strawberry_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/strawberry_desk_double_left");
             } else {
                modelLocation = modLoc("block/strawberry_desk_double_right");
             }
     ...
     //------------------------------------------------------------sugarapple-----------------------------------------------------------------------
         foodDeskCompat sugarappleDesk = foodblockcompatregistry.SUGARAPPLE_DESK.get();
         
         getVariantBuilder(sugarappleDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/sugarapple_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/sugarapple_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/sugarapple_desk_double_left");
             } else {
                modelLocation = modLoc("block/sugarapple_desk_double_right");
             }
     ...
     //------------------------------------------------------------cherry-----------------------------------------------------------------------
         foodDeskCompat cherryDesk = foodblockcompatregistry.CHERRY_DESK.get();
         
         getVariantBuilder(cherryDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/cherry_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/cherry_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/cherry_desk_double_left");
             } else {
                modelLocation = modLoc("block/cherry_desk_double_right");
             }
     ...
     //------------------------------------------------------------blackcherry-----------------------------------------------------------------------
         foodDeskCompat blackcherryDesk = foodblockcompatregistry.BLACKCHERRY_DESK.get();
         
         getVariantBuilder(blackcherryDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/blackcherry_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/blackcherry_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/blackcherry_desk_double_left");
             } else {
                modelLocation = modLoc("block/blackcherry_desk_double_right");
             }
     ...
     //------------------------------------------------------------peach-----------------------------------------------------------------------
         foodDeskCompat peachDesk = foodblockcompatregistry.PEACH_DESK.get();
         
         getVariantBuilder(peachDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/peach_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/peach_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/peach_desk_double_left");
             } else {
                modelLocation = modLoc("block/peach_desk_double_right");
             }
     ...
     //------------------------------------------------------------coconut-----------------------------------------------------------------------
         foodDeskCompat coconutDesk = foodblockcompatregistry.COCONUT_DESK.get();
         
         getVariantBuilder(coconutDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/coconut_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/coconut_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/coconut_desk_double_left");
             } else {
                modelLocation = modLoc("block/coconut_desk_double_right");
             }
     ...
     //------------------------------------------------------------orange-----------------------------------------------------------------------
         foodDeskCompat orangeDesk = foodblockcompatregistry.ORANGE_DESK.get();
         
         getVariantBuilder(orangeDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/orange_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/orange_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/orange_desk_double_left");
             } else {
                modelLocation = modLoc("block/orange_desk_double_right");
             }
     ...
     //------------------------------------------------------------tangerine-----------------------------------------------------------------------
         foodDeskCompat tangerineDesk = foodblockcompatregistry.TANGERINE_DESK.get();
         
         getVariantBuilder(tangerineDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/tangerine_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/tangerine_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/tangerine_desk_double_left");
             } else {
                modelLocation = modLoc("block/tangerine_desk_double_right");
             }
     ...
     //------------------------------------------------------------kumquat-----------------------------------------------------------------------
         foodDeskCompat kumquatDesk = foodblockcompatregistry.KUMQUAT_DESK.get();
         
         getVariantBuilder(kumquatDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/kumquat_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/kumquat_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/kumquat_desk_double_left");
             } else {
                modelLocation = modLoc("block/kumquat_desk_double_right");
             }
     ...
     //------------------------------------------------------------persimmon-----------------------------------------------------------------------
         foodDeskCompat persimmonDesk = foodblockcompatregistry.PERSIMMON_DESK.get();
         
         getVariantBuilder(persimmonDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/persimmon_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/persimmon_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/persimmon_desk_double_left");
             } else {
                modelLocation = modLoc("block/persimmon_desk_double_right");
             }
     ...
     //------------------------------------------------------------satsuma-----------------------------------------------------------------------
         foodDeskCompat satsumaDesk = foodblockcompatregistry.SATSUMA_DESK.get();
         
         getVariantBuilder(satsumaDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/satsuma_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/satsuma_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/satsuma_desk_double_left");
             } else {
                modelLocation = modLoc("block/satsuma_desk_double_right");
             }
     ...
     //------------------------------------------------------------mandarin-----------------------------------------------------------------------
         foodDeskCompat mandarinDesk = foodblockcompatregistry.MANDARIN_DESK.get();
         
         getVariantBuilder(mandarinDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/mandarin_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/mandarin_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/mandarin_desk_double_left");
             } else {
                modelLocation = modLoc("block/mandarin_desk_double_right");
             }
     ...
     //------------------------------------------------------------lemon-----------------------------------------------------------------------
         foodDeskCompat lemonDesk = foodblockcompatregistry.LEMON_DESK.get();
         
         getVariantBuilder(lemonDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/lemon_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/lemon_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/lemon_desk_double_left");
             } else {
                modelLocation = modLoc("block/lemon_desk_double_right");
             }
     ...
     //------------------------------------------------------------buddhashand-----------------------------------------------------------------------
         foodDeskCompat buddhashandDesk = foodblockcompatregistry.BUDDHASHAND_DESK.get();
         
         getVariantBuilder(buddhashandDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/buddhashand_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/buddhashand_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/buddhashand_desk_double_left");
             } else {
                modelLocation = modLoc("block/buddhashand_desk_double_right");
             }
     ...
     //------------------------------------------------------------lime-----------------------------------------------------------------------
         foodDeskCompat limeDesk = foodblockcompatregistry.LIME_DESK.get();
         
         getVariantBuilder(limeDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/lime_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/lime_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/lime_desk_double_left");
             } else {
                modelLocation = modLoc("block/lime_desk_double_right");
             }
     ...
     //------------------------------------------------------------keylime-----------------------------------------------------------------------
         foodDeskCompat keylimeDesk = foodblockcompatregistry.KEYLIME_DESK.get();
         
         getVariantBuilder(keylimeDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/keylime_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/keylime_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/keylime_desk_double_left");
             } else {
                modelLocation = modLoc("block/keylime_desk_double_right");
             }
     ...
     //------------------------------------------------------------fingerlime-----------------------------------------------------------------------
         foodDeskCompat fingerlimeDesk = foodblockcompatregistry.FINGERLIME_DESK.get();
         
         getVariantBuilder(fingerlimeDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/fingerlime_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/fingerlime_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/fingerlime_desk_double_left");
             } else {
                modelLocation = modLoc("block/fingerlime_desk_double_right");
             }
     ...
     //------------------------------------------------------------grapefruit-----------------------------------------------------------------------
         foodDeskCompat grapefruitDesk = foodblockcompatregistry.GRAPEFRUIT_DESK.get();
         
         getVariantBuilder(grapefruitDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/grapefruit_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/grapefruit_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/grapefruit_desk_double_left");
             } else {
                modelLocation = modLoc("block/grapefruit_desk_double_right");
             }
     ...
     //------------------------------------------------------------pomelo-----------------------------------------------------------------------
         foodDeskCompat pomeloDesk = foodblockcompatregistry.POMELO_DESK.get();
         
         getVariantBuilder(pomeloDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/pomelo_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/pomelo_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/pomelo_desk_double_left");
             } else {
                modelLocation = modLoc("block/pomelo_desk_double_right");
             }
     ...
     //------------------------------------------------------------corn-----------------------------------------------------------------------
         foodDeskCompat cornDesk = foodblockcompatregistry.CORN_DESK.get();
         
         getVariantBuilder(cornDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/corn_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/corn_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/corn_desk_double_left");
             } else {
                modelLocation = modLoc("block/corn_desk_double_right");
             }
     ...
     //------------------------------------------------------------onion-----------------------------------------------------------------------
         foodDeskCompat onionDesk = foodblockcompatregistry.ONION_DESK.get();
         
         getVariantBuilder(onionDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/onion_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/onion_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/onion_desk_double_left");
             } else {
                modelLocation = modLoc("block/onion_desk_double_right");
             }
     ...
     //------------------------------------------------------------pecan-----------------------------------------------------------------------
         foodDeskCompat pecanDesk = foodblockcompatregistry.PECAN_DESK.get();
         
         getVariantBuilder(pecanDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/pecan_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/pecan_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/pecan_desk_double_left");
             } else {
                modelLocation = modLoc("block/pecan_desk_double_right");
             }
     ...
     //------------------------------------------------------------almond-----------------------------------------------------------------------
         foodDeskCompat almondDesk = foodblockcompatregistry.ALMOND_DESK.get();
         
         getVariantBuilder(almondDesk)
         .forAllStates(state -> {
             Direction facing = state.getValue(BlockStateProperties.HORIZONTAL_FACING);
             Boolean isleft = state.getValue(foodDeskCompat.EAST_CONNECTED);
             Boolean isright = state.getValue(foodDeskCompat.WEST_CONNECTED);
             ...
             ResourceLocation modelLocation;
             if (!isleft && !isright) {
                 modelLocation = modLoc("block/almond_desk_single");
             } else if (isleft && isright) {
                 modelLocation = modLoc("block/almond_desk_triple_center");
             } else if (isleft && !isright) {
                 modelLocation = modLoc("block/almond_desk_double_left");
             } else {
                modelLocation = modLoc("block/almond_desk_double_right");
             }

...
public class smallFoodContainerEntity extends RandomizableContainerBlockEntity {
    ...
    public smallFoodContainerEntity(BlockPos pPos, BlockState pBlockState) {
        super(foodblockregistry.SMALL_CABINET_ENTITY.get(), pPos, pBlockState);
    }
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            smallFoodContainerEntity.this.playSound(p_155064_, SoundEvents.BARREL_OPEN);
            smallFoodContainerEntity.this.updateBlockState(p_155064_, true);
        }

        @Override
        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            smallFoodContainerEntity.this.playSound(p_155074_, SoundEvents.BARREL_CLOSE);
            smallFoodContainerEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        protected boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == smallFoodContainerEntity.this;
            } else {
                return false;
            }
        }
